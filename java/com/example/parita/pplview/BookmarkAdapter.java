...
/**
 * Created by parita on 10-03-2018.
 */

public class BookmarkAdapter extends ArrayAdapter<Posts> {
    ...
    public BookmarkAdapter(Context mCtx, int listLayoutRes, List<Posts> postsList, SQLiteDatabase mDatabase) {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        String sql = "DELETE FROM anonymous_bookmark WHERE heading = ?";
    ...
    private void reloadEmployeesFromDatabase() {
        Cursor cursorEmployees = mDatabase.rawQuery("SELECT * FROM anonymous_bookmark", null);
