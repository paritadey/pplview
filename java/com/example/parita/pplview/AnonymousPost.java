...
public class AnonymousPost extends AppCompatActivity {
    ...
    public class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        ProgressDialog pdLoading = new ProgressDialog(AnonymousPost.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("https://paritasampa95.000webhostapp.com/PeopleView/AnonymousPost.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("no rows")) {
                Toast.makeText(AnonymousPost.this, "No Post history found", Toast.LENGTH_LONG).show();
            }else{
                ...
                try {
                    ...
                    mRVFish.addItemDecoration(new background(AnonymousPost.this));
                    mAdapter = new MePostAdapter(AnonymousPost.this, data);
                    mRVFish.setAdapter(mAdapter);
                    mRVFish.setLayoutManager(new LinearLayoutManager(AnonymousPost.this));
                    ...
                    //Toast.makeText(AnonymousPost.this, "No Post history is present", Toast.LENGTH_LONG).show();
